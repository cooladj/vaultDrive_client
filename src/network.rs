...
pub struct QuicClient {
    endpoint: Endpoint,
    ///server socket: socketaddr, Connection: Quin Connection
...
/// Write a protobuf message with 4-byte length prefix
...
/// Read a protobuf message with 4-byte length prefix
